...
type AwsServiceCredentialsSource string

const (
	AwsServiceCredentialsSourceEc2InstanceMetadata AwsServiceCredentialsSource = "Ec2InstanceMetadata"
	AwsServiceCredentialsSourceEcsContainer        AwsServiceCredentialsSource = "EcsContainer"
)
...
type ProviderConfiguration struct {
	...
	AwsServiceCredentialsSource AwsServiceCredentialsSource `jsonapi:"attr,aws-service-credentials-source"`
...
type ProviderConfigurationCreateOptions struct {
	...
	AwsServiceCredentialsSource *AwsServiceCredentialsSource `jsonapi:"attr,aws-service-credentials-source,omitempty"`
